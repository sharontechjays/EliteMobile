...
const styles = StyleSheet.create({
  ...
  crewChip: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.progressTrack, borderRadius: 22, paddingVertical: 5, paddingHorizontal: 10, paddingLeft: 6 },
  ...
  notesButton: { paddingVertical: 13, borderRadius: 11, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.progressTrack, alignItems: "center" },
  ...
  jobButton: { flex: 1, paddingVertical: 13, borderRadius: 11, backgroundColor: colors.jobBg, borderWidth: 1, borderColor: colors.jobBorder, alignItems: "center" },
  jobButtonText: { fontSize: 12.5, fontWeight: "800", letterSpacing: 0.5, color: colors.job, textTransform: "uppercase" },
  timerBox: { paddingVertical: 10, paddingHorizontal: 14, borderRadius: 11, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.progressTrack, alignItems: "center", minWidth: 92 },
  ...
  pauseButton: { paddingVertical: 13, borderRadius: 11, backgroundColor: colors.idleBg, borderWidth: 1, borderColor: colors.idleBorder, alignItems: "center" },
  pauseButtonText: { fontSize: 12.5, fontWeight: "800", letterSpacing: 0.5, color: colors.idle, textTransform: "uppercase" },
  ...
  mealAction: { paddingVertical: 12, borderRadius: 11, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.border, alignItems: "center" },
  mealActionText: { fontSize: 12.5, fontWeight: "800", letterSpacing: 0.5, color: colors.ink, textTransform: "uppercase" },
  ...
  travelPromptCard: { backgroundColor: colors.travelCardBg, borderColor: colors.travelCardBorder, borderWidth: 1.5, borderRadius: 18, padding: 14, gap: 10 },
  ...
  travelPromptPrimary: { flex: 1, backgroundColor: colors.accent, borderRadius: 11, paddingVertical: 13, alignItems: "center" },
  travelPromptPrimaryText: { fontSize: 13, fontWeight: "800", color: colors.accentInk, textTransform: "uppercase" },
  travelPromptSecondary: { flex: 1, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.progressTrack, borderRadius: 11, paddingVertical: 13, alignItems: "center" },
  travelPromptSecondaryText: { fontSize: 12.5, fontWeight: "800", letterSpacing: 0.5, color: colors.ink, textTransform: "uppercase" },
});
